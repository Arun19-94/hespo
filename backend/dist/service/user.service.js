...
class UserService {
    constructor() {
        ...
        this.getUserByEmail = (email) => __awaiter(this, void 0, void 0, function* () {
            return yield user_model_1.default.findOne({ email: email }).populate("login");
        });
        this.getAnyUser = () => __awaiter(this, void 0, void 0, function* () {
            let user = yield user_model_1.default.findOne({ email: "ABC@gmail.com" });
            return user;
        });
        this.createUser = (user) => __awaiter(this, void 0, void 0, function* () {
            try {
                let _user = new user_model_1.default(user);
                return yield _user.save();
            }
            catch (error) {
                throw (error);
            }
